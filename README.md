...
This tool allows for the creation of simplified UML Class Diagrams through an interactive modeling interface. The modeler was created based on this [template repository](https://github.com/bptlab/openbpt-modeler-template) and heavily relies on [diagram-js](https://github.com/bpmn-io/diagram-js).
