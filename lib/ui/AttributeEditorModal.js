...
export function openAttributeEditor({
  ...
  btnCancel.style.cssText =
    "padding:6px 12px;background:#fff;border:1px solid #ccc;border-radius:4px;cursor:pointer;";

  const btnSave = document.createElement("button");
  btnSave.textContent = "Save";
  btnSave.style.cssText =
    "padding:6px 12px;background:#007acc;color:#fff;border:0;border-radius:4px;cursor:pointer;";
  ...
  function createRow(attr = { visibility: "none", name: "", type: "" }) {
    ...
    delBtn.style.cssText =
      "padding:4px 8px;background:#e04;border:0;color:#fff;border-radius:4px;cursor:pointer;";
  ...
  addBtn.style.cssText =
    "padding:6px 12px;background:#2a9f5b;color:#fff;border:0;border-radius:4px;cursor:pointer;";
