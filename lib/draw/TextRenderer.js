...
import TextUtil from "./TextRendererUtil";
...
export default class TextRenderer {
  ...
  // Return layout dimensions for given text and options
  getDimensions = function (text, options) {
    return this._textUtil.getDimensions(text, options || {});
  };
