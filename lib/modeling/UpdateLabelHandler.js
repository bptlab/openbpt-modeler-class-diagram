...
export default class UpdateLabelHandler {
  ...
  setText(element, text, oldText = "", editedAttribute) {
  ...
  execute(context) {
    ...
    const editedAttribute =
      context.hints?.editedAttribute || getLabelAttribute(element);
    const oldLabel = getLabel(element, editedAttribute);
    context.hints = { ...context.hints, editedAttribute };
  ...
  revert(context) {
    ...
    const editedAttribute = context.hints?.editedAttribute;
